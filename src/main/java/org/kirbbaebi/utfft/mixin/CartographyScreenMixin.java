...
public abstract class CartographyScreenMixin extends HandledScreen<CartographyTableScreenHandler> {

    @Shadow
    static Identifier TEXTURE;

    @Unique
    GuiProps properties = GuiPropAPI.getProps("cartography_table");

    public CartographyScreenMixin(CartographyTableScreenHandler handler, PlayerInventory inventory, Text title) {
